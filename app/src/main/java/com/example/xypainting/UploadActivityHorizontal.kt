...
class UploadActivityHorizontal : AppCompatActivity() {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_upload_horizontal)

        imageView = findViewById(R.id.painting2)
        //imageView.setImageBitmap(Bitmap.createBitmap(400,400,Bitmap.Config.ARGB_8888))
        //bitmaps could be used to enable drawing on an image
        ...
        bttnVertical = findViewById(R.id.button_vertical)

        bttnVertical.setOnClickListener {
            val intent = Intent(this, UploadActivityVertical::class.java)
            startActivity(intent)
        }
}
